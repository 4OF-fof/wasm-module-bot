...
export type ManifestResult =
  | { status: "ok"; manifest: PluginManifest }
  | { status: "err"; error: PluginError };
...
export type TriggerGroup =
  | {
      ...
      name: string;
      description: string;
      sources: Array<TriggerSource>;
    }
  | { type: "none" };

export type TriggerSource =
  | { type: "discordSlashCommand"; commandName: string }
  | { type: "discordMessage"; content: string };

export type Capability =
  | { type: "discord.interaction.reply" }
  | { type: "http.get"; originPolicy: HttpOriginPolicy }
  | { type: "message.send" };
...
export type BotEvent =
  | {
      ...
      modules: Array<PluginModuleInfo>;
    }
  | { type: "discord.message"; trigger: string; channelId: string; content: string }
  | { type: "effect.result"; trigger: string; effectId: string; result: EffectResult };
...
export type EffectRequest =
  ...
  | { type: "http.fetch"; id: string; method: HttpMethod; url: string }
  | { type: "message.send"; id: string; channelId: string; text: string };
